...
- **[Real-Sheet Score Creation & Editing UI Refactor Proposal (擬真簡譜樂譜編輯重構計畫)](./REAL_SHEET_UI_REFACTOR_PROPOSAL.md)**
  - 徹底打破 DAW/卡片網格框架，打造如同實體紙本樂譜（如《望春風》經典簡譜）的「即看即編（What You See Is What You Compose）」創作環境。
  - 擬真紙本畫布（Sheet Paper Canvas）、自動連續樑線引擎（Continuous Beams）、樂譜原位插入游標（Music Caret）與鍵盤打字機輸入矩陣。
  - 多段歌詞垂直疊加排版、跳躍反覆房子（Voltas）、SVG 圓滑弧線與出版級無損列印匯出。
